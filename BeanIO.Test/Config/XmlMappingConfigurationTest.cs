...
namespace BeanIO.Config
{
    public class XmlMappingConfigurationTest : ParserTest
    {
        ...
        {
            LoadInvalidMappingFile("invalidImport_ResourceNotFound.xml", "Resource 'resource:BeanIO.Config.doesnotexist.xml, BeanIO.Test' not found in classpath for import");
        }
