...
namespace BeanIO.Internal.Config.Xml
{
    ...
    internal class XmlMapping
    {
        ...
        /// or <see langword="null" /> if this file is the "root" mapping file.
        /// </summary>
        ...
        /// <returns><c>true</c> if the given location is being actively
        ...
        /// <returns><c>true</c> if the template was successfully added, or
        /// <see langword="false" /> if the template name already existed.</returns>
        ...
        /// <summary>
        /// Recursively finds the <c>template</c> DOM element for a given template
        ...
        /// <returns><c>true</c> if a type handler was declared globally
